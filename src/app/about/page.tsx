    ...
    <main>
      ...
      <div className="relative h-80 bg-gray-100">
        ...
        <div className="absolute inset-0 bg-black bg-opacity-30 flex items-center justify-center">
          <h1 className="text-4xl md:text-5xl font-mingtc font-bold text-white">
            關於我
          </h1>
        </div>
      </div>
        ...
        <div className="art-container">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-16">
            <div className="space-y-6">
              <h2 className="text-3xl font-mingtc font-bold text-black mb-4">
                藝術<span className="text-accent">故事</span>
              </h2>
              <p className="text-black leading-relaxed font-mingtc">
                嗨，我是Victoria Spicer，一位充滿熱情的藝術創作者。我的創作之旅始於2010年，當時我剛從藝術學院畢業，
            ...
            <div className="relative h-[500px] overflow-hidden">
              <Image
                src="/images/v_spinning.jpg"
                alt="Victoria Spicer 藝術創作"
                fill
                className="object-cover"
                priority
              />
          ...
          {/* 創作理念 */}
          <div className="mb-16">
            <h2 className="text-3xl font-mingtc font-bold text-black mb-8 text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-white p-8 text-center">
                ...
                <h3 className="text-xl font-mingtc font-semibold mb-4">熱情</h3>
                <p className="text-black font-mingtc">
              ...
              <div className="bg-white p-8 text-center">
                ...
                <h3 className="text-xl font-mingtc font-semibold mb-4">獨特</h3>
                <p className="text-black font-mingtc">
              ...
              <div className="bg-white p-8 text-center">
                ...
                <h3 className="text-xl font-mingtc font-semibold mb-4">品質</h3>
                <p className="text-black font-mingtc">
            ...
            <div className="space-y-8">
              <div className="flex flex-col md:flex-row gap-4">
                ...
                <div className="md:w-3/4 border-l-2 border-accent-light pl-6 pb-8">
                  <h3 className="text-xl font-mingtc font-semibold mb-2">藝術啟程</h3>
                  <p className="text-black font-mingtc">
              ...
              <div className="flex flex-col md:flex-row gap-4">
                ...
                <div className="md:w-3/4 border-l-2 border-accent-light pl-6 pb-8">
                  <h3 className="text-xl font-mingtc font-semibold mb-2">拓展領域</h3>
                  <p className="text-black font-mingtc">
              ...
              <div className="flex flex-col md:flex-row gap-4">
                ...
                <div className="md:w-3/4 border-l-2 border-accent-light pl-6">
                  <h3 className="text-xl font-mingtc font-semibold mb-2">全面發展</h3>
                  <p className="text-black font-mingtc">
          ...
          <div className="mt-16 text-center">
            <h2 className="text-3xl font-mingtc font-bold text-black mb-8">
              作品<span className="text-accent">展示</span>
            </h2>
            <div className="max-w-3xl mx-auto bg-white p-8">
              ...
              <p className="mt-6 text-black font-mingtc text-lg">
                「旋轉系列」- 這是我最新的藝術創作，透過旋轉的形態表達生命的流動與變化。
              </p>
            </div>
          </div>
        </div>
